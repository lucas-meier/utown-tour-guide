...
namespace Microsoft.Azure.ObjectAnchors.Unity.Sample
{
    public class TrackableObjectMenu : MonoBehaviour
    {
        ...
        public TextMesh SearchDistanceSliderLabel = null;
        ...
        public void SearchDistanceSliderChanged(SliderEventData sliderEventData)
        {
            _objectTracker.SearchDistance = sliderEventData.NewValue;
            SearchDistanceSliderLabel.text = $"Search Distance {(_objectTracker.SearchDistance * 10).ToString("F2")}";
        }
