...
namespace Microsoft.Azure.ObjectAnchors.Unity.Sample
{
    ...
    public class ObjectTracker : MonoBehaviour
    {
        ...
        private bool _multiAnchorPlacement = false;
        ...
        private float _coverageThresholdFactor = 0.01f;
        ...
        private float _searchDistance = 0.4f;
        ...
        public float SearchDistance
        {
            ...
            set
            {
                _searchDistance = Mathf.Clamp(value, 0.01f, 1.0f);
            }
        }

        public event Action<IObjectAnchorsServiceEventArgs> OnObjectAddedOrUpdated;
        public event Action<IObjectAnchorsServiceEventArgs> OnObjectRemoved;
...
#region Callbacks
        ...
        private void AddOrUpdate(IObjectAnchorsServiceEventArgs e)
        {
            ...
            OnObjectAddedOrUpdated?.Invoke(e);
        }
#endregion
        ...
        public async void QueueQueriesInBounds(ObjectAnchorsBoundingBox queryBounds)
        {
            ...
            foreach (TrackableObjectQuery toq in _trackableObjectQueries)
            {
                ...
                SpatialFieldOfView fieldOfView = new SpatialFieldOfView
                {
                    ...
                    FarDistance = SearchDistance * 10.0f, // Far distance in meters of object search frustum.
                ...
                */
                nextQuery.SearchAreas.Add(ObjectSearchArea.FromFieldOfView(
                    coordinateSystem.Value,
                    fieldOfView
                    ));
