...
#region Unity script behavior
        ...
        private async void Start()
        {
            ...
            //
            Microsoft.MixedReality.Toolkit.CoreServices.InputSystem?.PushFallbackInputHandler(gameObject);
        ...
        {
            Microsoft.MixedReality.Toolkit.CoreServices.InputSystem?.PopFallbackInputHandler();
